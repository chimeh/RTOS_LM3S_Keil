...
// 
// This is part of revision 3618 of the Stellaris Graphics Library.
//
//*****************************************************************************
...
{
    //
    // Make sure we were passed valid rectangles.  We actually expect invalid
    // rectangles passed in cases where the slider is at either end of its
    // range.  This is used to indicate that one or other of the active or
    // empty (background) rectangles should not be drawn.
    //
